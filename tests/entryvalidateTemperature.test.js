const { validateTemperature, validateTemperatureWithLastEntry,validateTemperatureWithHighestandLowest, validateEntry } = require("../services/entryvalidateService");
